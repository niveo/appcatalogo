...
class CatalogoPaginaCompose(
    ...
    @Composable
    fun CatalogoPaginaDialog(onDismissRequest: () -> Unit) {
        Dialog(
    ...
    @Composable
    private fun CatalogoPaginaView(onItemClick: (registro: CatalogoPagina) -> Unit) {
    ...
    @Composable
    private fun CatalogoPaginaListView(onItemClick: (registro: CatalogoPagina) -> Unit) {
    ...
    @Composable
    private fun CatalogoPaginaListViewItem(
